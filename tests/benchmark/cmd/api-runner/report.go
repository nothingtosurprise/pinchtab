...
func BuildProgressSummary(reportFile string) string {
	...
	lines = append(lines, "Use the report file and benchmark wrappers as the source of truth.")
	lines = append(lines, "Do not re-read large documentation files unless you are blocked on a specific syntax detail.")
