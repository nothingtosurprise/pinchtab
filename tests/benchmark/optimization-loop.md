...
1. Add or update fixture files.
2. Add the executable baseline case in `scripts/baseline.sh`.
3. Add the matching shared task in `benchmark-run/group-XX.md` and keep `benchmark-run/index.md` current.
...
- use `setup-pinchtab.md`
- use `benchmark-run/index.md` plus the relevant `benchmark-run/group-XX.md` files
- use only `./scripts/pt` for browser work
- record with `record-step.sh --type pinchtab`
- verify with `verify-step.sh --type pinchtab`
